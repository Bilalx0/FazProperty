...
export async function registerRoutes(app: Express): Promise<void> {
  try {
    ...
    // [Add other routes (neighborhoods, developments, etc.) here similarly]

    // Add remaining routes (neighborhoods, developments, enquiries, etc.) with the same error handling pattern
